...
class Fuzz4sRichShort(i: Short) {
  def reverseBytes: Short = Short.reverseBytes(i)
}

class Fuzz4sRichInt(i: Int) {
  def reverseBytes: Int = Integer.reverseBytes(i)
}

class Fuzz4sRichLong(i: Long) {
  def reverseBytes: Long = Long.reverseBytes(i)
}
