...
import com.automatak.aegis.japi.phys.{ ChannelFactory, ReadableWritableChannel }
import com.automatak.aegis.sapi.TestLogger

class TcpClientChannelFactory(host: String, port: Int, logger: TestLogger) extends ChannelFactory {
