...
object Group52Var1 extends FixedSizeGroupVariation(Group52, 1, 2) with InformationGroupVariation
object Group52Var2 extends FixedSizeGroupVariation(Group52, 2, 2) with InformationGroupVariation
