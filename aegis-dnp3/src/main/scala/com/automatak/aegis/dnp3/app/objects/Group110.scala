...
import com.automatak.aegis.dnp3.app.{ FixedSizeGroupVariation, ObjectGroup, StaticGroupVariation }

object Group110 extends ObjectGroup {
  def objects = List(Group110Var0)
  def group: Byte = 110
}

object Group110Var0 extends FixedSizeGroupVariation(Group110, 0, 0) with StaticGroupVariation
